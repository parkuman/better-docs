/**
 * Fork of JSDoc's util. We need to modify markdown-it and they don't allow!
 * So we're forking for now.
 */
...
const mim = require('markdown-it-mermaid').default;
...
function getParseFunction(parserName, conf) {
    ...
    switch (parserName) {
        ...
        case parserNames.markdownit:
            ...
            renderer.use(mda, {permalink: true, permalinkBefore: true, permalinkSymbol: "#"});
            renderer.use(mim);
